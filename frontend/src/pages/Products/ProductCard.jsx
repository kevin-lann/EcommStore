    ...
    <div className="max-w-sm relative rounded-lg shadow">
      <section className="relative">
        <Link to={`/product/${p._id}`}>
          <span className="absolute bottom-3 right-3 bg-orange-200 text-orange-600 text-sm font-medium mr-2 px-2.5 py-0.5 rounded-full ">
            {p?.brand}
          </span>
          <img
            className="cursor-pointer w-[22rem] object-cover"
            src={p.image}
            alt={p.name}
      ...
      <div className="p-5">
        <div className="flex justify-between">
          ...
          <p className="text-black font-semibold text-black">
